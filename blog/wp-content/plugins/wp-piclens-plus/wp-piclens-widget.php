...
/*
Plugin Name: WP PicLens Plus Slideshow Widget
...
function widget_piclens_init() {
    ...
    function widget_piclens($args) {
        ...
        // plplus: closed the list item with a </li>
        echo '<ul><li><a style="align: right;" href="javascript:toggleStartStop();PicLensLite.start({feedUrl:\'' . wp_piclens_base_uri() . '/mrss.php\'});">' . $slideshowLinkText . '</a></li></ul>';
...
//*****************************************************************************
//
// FUNCTION: widget_piclens_change_status
//
...
function widgetHTML() {
    ...
    if (!$widgetHTML) {
        // plplus: changed height to a style
        $widgetHTML = '<div id="noImages"><table style="height:100%;" border="0" width="100%"><tr><td><strong><font color="#C0C0C0">NO IMAGES AVAILABLE</font></strong></td></tr></table></div>';
    }
    return $widgetHTML;
}
