<?php
	echo "<h4>Bible Study Questions</h4>
			<p />Documents are posted in order by most recent first.  You can click on the title or image to view the message, or right-click and Save As to download the file.";

	$sql_message = mysql_query("SELECT a.*, b.*  from posts a, category b where a.category_id = 2 and a.category_id = b.category_id order by post_date");
